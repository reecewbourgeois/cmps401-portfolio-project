  ...
  return (
    <div className="reeces-page">
          ...
          <Events>
            ...
            <TextEvent date="2021 - Present" text="">
              ...
              <ListGroup horizontal className="align-self-center">
                <ListGroup.Item className="reeces-code-list-item">
                  Node.js
                </ListGroup.Item>
                <ListGroup.Item className="reeces-code-list-item">
                  Express.js
              ...
              <h6 className="mt-2 align-self-center">
                A web app for a client to track project cost estimation and
                payroll.
              </h6>
            </TextEvent>
            ...
            <TextEvent date="2020" text="">
              ...
              <h6 className="mt-2 align-self-center">
                An internal web app for inventory management and repair tracking
      ...
      <Modal show={show} onHide={handleClose}>
        <Document
          className="reeces-get-rid-of-extra-space-at-bottom"
          file={ReecesResume}
        >
          <Page pageNumber={1} />
        </Document>
